...
if (cfg2$run_analysis) {
  ...
  if (cfg2$parallelize) {
    ...
    objs_to_export <- c("f_x", "f_y", "f_z", "icll", "lik_fn2", "inds",
                        "batches", "uncompress")
  ...
  if (cfg$model_version==0) {
    ...
    par_init <- c(a_x=-3.5607, g_x1=-0.3244, g_x2=-0.2809, t_x=-0.786, a_s=-2.87, g_s1=-0.3768, g_s2=0.6409, beta_x=1.8096, beta_z=1.8153, a_y=-5.7446, g_y1=0.3278, g_y2=4.2046, t_y=-0.7826, pi=0.1)
  }
