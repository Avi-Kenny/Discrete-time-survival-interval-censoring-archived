...
if (cfg2$run_analysis) {
  ...
  if (cfg$model_version==0) {
    ...
    par_init <- c(a_x=-8.0742, g_x1=-0.7309, g_x2=2.2824, g_x3=-0.2813, g_x4=-0.2839, g_x5=-5.8632, t_x=-1.3492, a_s=-3.7151, g_s1=-0.4807, g_s2=1.1155, t_s=1.1718, beta_x=1.1894, beta_z=0.8276, a_y=-8.657, g_y1=0.4471, g_y2=2.0150, g_y3=3.2520, g_y4=6.4782, g_y5=3.2216, t_y=-0.7018)
  }
