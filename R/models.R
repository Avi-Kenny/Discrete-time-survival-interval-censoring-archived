...
if (cfg$model_version==7) {
  ...
  terms_y2_F <- function(x, j, w_1) { c(x, x*j, x*max(w_1-0.3,0), x*j*max(w_1-0.3,0), x*max(w_1-0.45,0), x*j*max(w_1-0.45,0), 1, b9(w_1,1), b9(w_1,2), b9(w_1,3), b9(w_1,4), b10(j,1), b10(j,2), b10(j,3), b10(j,4)) }
  par_y_M <- par_y_F; terms_y_M <- terms_y_F; terms_y2_M <- terms_y2_F;
  ...
  terms_y2_F <- function(x, j, w_1) { c(x, x*j, x*w_1, x*j*w_1, 1, b9(w_1,1), b9(w_1,2), b9(w_1,3), b9(w_1,4), b10(j,1), b10(j,2), b10(j,3), b10(j,4)) }
  par_y_M <- par_y_F; terms_y_M <- terms_y_F; terms_y2_M <- terms_y2_F;
} else if (cfg$model_version==31) {
  par_y_F <- c("beta_x1", "beta_x2", "beta_x3", "beta_x4", "beta_x5", "beta_x6", "a_y", "g_y1", "g_y2", "g_y3", "g_y4", "t_y1", "t_y2", "t_y3", "t_y4")
  ...
  terms_y2_F <- function(x, j, w_1) { c(x, x*j, x*max(w_1-0.2,0), x*j*max(w_1-0.2,0), x*min(max(w_1-0.4,0),0.5), x*j*min(max(w_1-0.4,0),0.5), 1, b9(w_1,1), b9(w_1,2), b9(w_1,3), b9(w_1,4), b10(j,1), b10(j,2), b10(j,3), b10(j,4)) }
  par_y_M <- par_y_F; terms_y_M <- terms_y_F; terms_y2_M <- terms_y2_F;
} else if (cfg$model_version==32) {
  ...
  terms_y2_F <- function(x, j, w_1) { c(x*1, x*j, x*max(j-0.6,0), x*w_1, x*w_1*j, x*w_1*max(j-0.6,0), x*max(w_1-0.4,0), x*max(w_1-0.4,0)*j, x*max(w_1-0.4,0)*max(j-0.6,0), 1, b9(w_1,1), b9(w_1,2), b9(w_1,3), b9(w_1,4), b10(j,1), b10(j,2), b10(j,3), b10(j,4)) }
  par_y_M <- par_y_F; terms_y_M <- terms_y_F; terms_y2_M <- terms_y2_F;
} else if (cfg$model_version==33) {
  par_y_F <- c("beta_x1", "beta_x2", "beta_x3", "beta_x4", "beta_x5", "beta_x6", "beta_x7", "beta_x8", "beta_x9", "a_y", "g_y1", "g_y2", "g_y3", "g_y4", "t_y1", "t_y2", "t_y3", "t_y4")
  ...
  terms_y2_F <- function(x, j, w_1) { c(x*1, x*j, x*j^2, x*w_1, x*w_1*j, x*w_1*j^2, x*w_1^2, x*w_1^2*j, x*w_1^2*j^2, 1, b9(w_1,1), b9(w_1,2), b9(w_1,3), b9(w_1,4), b10(j,1), b10(j,2), b10(j,3), b10(j,4)) }
  par_y_M <- par_y_F; terms_y_M <- terms_y_F; terms_y2_M <- terms_y2_F;
} else if (cfg$model_version %in% c(34:35)) {
  par_y_F <- c("beta_x1", "beta_x2", "beta_x3", "beta_x4", "a_y", "g_y1", "g_y2", "g_y3", "g_y4", "t_y1", "t_y2", "t_y3", "t_y4")
  terms_y_F <- function(r, x) { c(x, x*r[["j"]], x*r[["w_1"]], x*r[["j"]]*r[["w_1"]], 1, r[["b9_1"]], r[["b9_2"]], r[["b9_3"]], r[["b9_4"]], r[["b12_1"]], r[["b12_2"]], r[["b12_3"]], r[["b12_4"]]) }
  terms_y2_F <- function(x, j, w_1) { c(x, x*j, x*w_1, x*j*w_1, 1, b9(w_1,1), b9(w_1,2), b9(w_1,3), b9(w_1,4), b12(j,1), b12(j,2), b12(j,3), b12(j,4)) }
  par_y_M <- par_y_F; terms_y_M <- terms_y_F; terms_y2_M <- terms_y2_F;
  ...
  terms_y2_F <- function(x, j, w_1) { c(x, x*j, x*w_1, x*j*w_1, 1, b13(w_1,1), b13(w_1,2), b13(w_1,3), b13(w_1,4), b14(j,1), b14(j,2), b14(j,3), b14(j,4)) }
  par_y_M <- par_y_F; terms_y_M <- terms_y_F; terms_y2_M <- terms_y2_F;
} else if (cfg$model_version==41) {
  par_y_F <- c("beta_x1", "beta_x2", "beta_x3", "beta_x4", "beta_x5", "beta_x6", "beta_x7", "beta_x8", "beta_x9", "a_y", "g_y1", "g_y2", "g_y3", "g_y4", "t_y1", "t_y2", "t_y3", "t_y4")
  ...
  terms_y2_F <- function(x, j, w_1) { c(x, x*j, x*j^2, x*w_1, x*j*w_1, x*j^2*w_1, x*w_1^2, x*j*w_1^2, x*j^2*w_1^2, 1, b13(w_1,1), b13(w_1,2), b13(w_1,3), b13(w_1,4), b14(j,1), b14(j,2), b14(j,3), b14(j,4)) }
  par_y_M <- par_y_F; terms_y_M <- terms_y_F; terms_y2_M <- terms_y2_F;
} else if (cfg$model_version==42) {
  par_y_F <- c("beta_x1", "beta_x2", "beta_x3", "beta_x4", "beta_x5", "beta_x6", "beta_x7", "beta_x8", "beta_x9", "a_y", "g_y1", "g_y2", "g_y3", "g_y4", "g_y5", "t_y1", "t_y2", "t_y3", "t_y4")
  terms_y_F <- function(r, x) { c(x, x*r[["j"]], x*r[["j"]]^2, x*r[["w_1"]], x*r[["j"]]*r[["w_1"]], x*r[["j"]]^2*r[["w_1"]], x*r[["w_1"]]^2, x*r[["j"]]*r[["w_1"]]^2, x*r[["j"]]^2*r[["w_1"]]^2, 1, r[["b13_1"]], r[["b13_2"]], r[["b13_3"]], r[["b13_4"]], r[["w_1"]], r[["b14_1"]], r[["b14_2"]], r[["b14_3"]], r[["b14_4"]]) }
  terms_y2_F <- function(x, j, w_1, w_2) { c(x, x*j, x*j^2, x*w_1, x*j*w_1, x*j^2*w_1, x*w_1^2, x*j*w_1^2, x*j^2*w_1^2, 1, b13(w_1,1), b13(w_1,2), b13(w_1,3), b13(w_1,4), w_2, b14(j,1), b14(j,2), b14(j,3), b14(j,4)) }
  par_y_M <- par_y_F; terms_y_M <- terms_y_F; terms_y2_M <- terms_y2_F;
}
...
if (cfg$model_version==7) {
  ...
  terms_x2_F <- function(j, w_1) { c(1, b10(j,1), b10(j,2), b10(j,3), b10(j,4), b9(w_1,1), b9(w_1,2), b9(w_1,3), b9(w_1,4)) }
  par_x_M <- par_x_F; terms_x_M <- terms_x_F; terms_x2_M <- terms_x2_F;
} else if (cfg$model_version==34) {
  par_x_F <- c("a_x", "t_x1", "t_x2", "t_x3", "t_x4", "g_x1", "g_x2", "g_x3", "g_x4")
  terms_x_F <- function(r) { c(1, r[["b12_1"]], r[["b12_2"]], r[["b12_3"]], r[["b12_4"]], r[["b9_1"]], r[["b9_2"]], r[["b9_3"]], r[["b9_4"]]) }
  terms_x2_F <- function(j, w_1) { c(1, b12(j,1), b12(j,2), b12(j,3), b12(j,4), b9(w_1,1), b9(w_1,2), b9(w_1,3), b9(w_1,4)) }
  par_x_M <- par_x_F; terms_x_M <- terms_x_F; terms_x2_M <- terms_x2_F;
} else if (cfg$model_version==35) {
  par_x_F <- c("a_x", "t_x1", "g_x1", "g_x2", "g_x3", "g_x4")
  terms_x_F <- function(r) { c(1, r[["j"]], r[["b9_1"]], r[["b9_2"]], r[["b9_3"]], r[["b9_4"]]) }
  terms_x2_F <- function(j, w_1) { c(1, j, b9(w_1,1), b9(w_1,2), b9(w_1,3), b9(w_1,4)) }
  par_x_M <- par_x_F; terms_x_M <- terms_x_F; terms_x2_M <- terms_x2_F;
} else if (cfg$model_version==37) {
  par_x_F <- c("a_x", "t_x1", "t_x2", "t_x3", "t_x4", "g_x1", "g_x2", "g_x3", "g_x4")
  terms_x_F <- function(r) { c(1, r[["b14_1"]], r[["b14_2"]], r[["b14_3"]], r[["b14_4"]], r[["b13_1"]], r[["b13_2"]], r[["b13_3"]], r[["b13_4"]]) }
  terms_x2_F <- function(j, w_1) { c(1, b14(j,1), b14(j,2), b14(j,3), b14(j,4), b13(w_1,1), b13(w_1,2), b13(w_1,3), b13(w_1,4)) }
  par_x_M <- par_x_F; terms_x_M <- terms_x_F; terms_x2_M <- terms_x2_F;
} else if (cfg$model_version==38) {
  ...
  terms_x2_F <- function(j, w_1) { c(1, b14(j,1), b14(j,2), b14(j,3), b14(j,4), b15(w_1,1), b15(w_1,2), b15(w_1,3)) }
  par_x_M <- par_x_F; terms_x_M <- terms_x_F; terms_x2_M <- terms_x2_F;
  ...
  terms_x2_M <- function(j, w_1) { c(1, b14(j,1), b14(j,2), b14(j,3), b14(j,4), b15(w_1,1), b15(w_1,2), b15(w_1,3)) }
} else if (cfg$model_version==42) {
...
if (cfg$model_version==7) {
  ...
  terms_s2_F <- function(j, w_1) { c(1, b9(w_1,1), b9(w_1,2), b9(w_1,3), b9(w_1,4)) }
  par_s_M <- par_s_F; terms_s_M <- terms_s_F; terms_s2_M <- terms_s2_F;
} else if (cfg$model_version %in% c(37:39)) {
  par_s_F <- c("a_s", "g_s1", "g_s2", "g_s3", "g_s4")
  terms_s_F <- function(r) { c(1, r[["b13_1"]], r[["b13_2"]], r[["b13_3"]], r[["b13_4"]]) }
  terms_s2_F <- function(j, w_1) { c(1, b13(w_1,1), b13(w_1,2), b13(w_1,3), b13(w_1,4)) }
  par_s_M <- par_s_F; terms_s_M <- terms_s_F; terms_s2_M <- terms_s2_F;
  ...
  terms_s2_F <- function(j, w_1) { c(1, b13(w_1,1), b13(w_1,2), b13(w_1,3), b13(w_1,4), j) }
  par_s_M <- par_s_F; terms_s_M <- terms_s_F; terms_s2_M <- terms_s2_F;
} else if (cfg$model_version==42) {
