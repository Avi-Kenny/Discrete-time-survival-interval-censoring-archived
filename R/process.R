...
prob <- function(type, m, j, w_1, w_2) {
  ...
  if (m==7) {
    ...
    p <- list(
      # a_x=-7.855, g_x1=4.791, g_x2=-0.935, g_x3=0.844, g_x4=-8.116, g_x5=2.804,  # Window start 2000
      # g_x6=-2.155, g_x7=5.066, g_x8=-5.616, t_x1=-1.084, t_x2=-0.764,            # Window start 2000
      # t_x3=-1.505, t_x4=-2.598, a_s=-3.043, g_s1=-0.281, g_s2=1.184, g_s3=0.219, # Window start 2000
      # g_s4=3.380, g_s5=-3.239, beta_x1=2.636, beta_x2=-1.051, beta_z1=3.983,     # Window start 2000
      # beta_z2=-1.870, a_y=-7.221, g_y1=0.411, g_y2=1.692, g_y3=3.440,            # Window start 2000
      # g_y4=6.288, g_y5=3.826, t_y1=0.413, t_y2=0.030, t_y3=0.530, t_y4=-0.235    # Window start 2000
      a_x=-8.725, g_x1=3.414, g_x2=-0.561, g_x3=0.040, g_x4=-6.618, g_x5=-0.058,   # Window start 2010
      g_x6=0.498, g_x7=6.534, g_x8=-4.481, t_x1=-1.146, t_x2=-1.745,               # Window start 2010
      t_x3=-0.895, t_x4=-2.134, a_s=-2.914, g_s1=-0.435, g_s2=1.418, g_s3=-0.779,  # Window start 2010
      g_s4=3.834, g_s5=-2.681, beta_x1=1.813, beta_x2=-1.234, beta_z1=3.826,       # Window start 2010
    ...
    p <- list(
      a_x=-8.567, g_x1=2.507, g_x2=-0.537, g_x3=-1.743, g_x4=-8.788,
      g_x5=-1.952, g_x6=0.833, g_x7=6.446, g_x8=-4.131, t_x1=0.772, t_x2=-0.797,
      t_x3=0.015, t_x4=-1.276, a_s=-2.914, g_s1=-0.455, g_s2=1.383, g_s3=-0.784,
      g_s4=3.879, g_s5=-2.659, beta_x1=1.818, beta_x2=-1.261, beta_z1=3.829,
      beta_z2=-4.027, a_y=-7.330, g_y1=0.568, g_y2=1.865, g_y3=3.614,
      g_y4=6.156, g_y5=3.917, t_y1=-0.142, t_y2=0.151, t_y3=0.308, t_y4=-0.183
    )
  } else if (m==20) {
    p <- list(
      # a_x=-8.536, g_x1=2.821, g_x2=-1.430, g_x3=3.236, g_x4=-1.316, g_x5=-0.782,
      # g_x6=-0.062, g_x7=7.308, g_x8=-2.492, t_x1=0.140, t_x2=-1.089,
      # t_x3=-0.109, t_x4=-1.501, a_s=-3.091, g_s1=-0.405, g_s2=1.427,
      # g_s3=-0.460, g_s4=3.556, g_s5=-3.865, beta_x1=0.701, beta_x2=-0.204,
      # beta_x3=1.971, beta_x4=-0.969, beta_z1=1.632, beta_z2=-1.914,
      # beta_z3=1.926, beta_z4=-4.433, a_y=-7.035, g_y1=0.553, g_y2=2.190,
      # g_y3=3.763, g_y4=7.070, g_y5=3.879, t_y1=-1.001, t_y2=0.122, t_y3=-1.034,
      # t_y4=-0.586
      a_x=-8.416, g_x1=3.267, g_x2=-4.804, g_x3=2.036, g_x4=-0.286, g_x5=-2.404,
      g_x6=0.043, g_x7=7.351, g_x8=-2.296, t_x1=0.482, t_x2=-1.714, t_x3=0.389,
      t_x4=-0.572, a_s=-3.098, g_s1=-0.448, g_s2=1.403, g_s3=-0.417, g_s4=3.518,
      g_s5=-4.021, beta_x1=0.479, beta_x2=-0.315, beta_x3=1.545, beta_x4=-0.902,
      beta_z1=0.050, beta_z2=-1.719, beta_z3=2.602, beta_z4=-4.326, a_y=-6.977,
      g_y1=0.547, g_y2=2.327, g_y3=3.630, g_y4=7.219, g_y5=3.897, t_y1=-0.957,
      t_y2=0.184, t_y3=-1.456, t_y4=-0.870
    )
  }
